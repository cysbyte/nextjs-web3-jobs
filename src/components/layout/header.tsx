    ...
    >
      <div className="flex justify-between py-3 items-center font-comic">
        <div className="basis-1/2 lg:basis-1/3 flex justify-start items-center">
          ...
          <Link
              className="hidden lg:block text-sm ml-1 py-2 px-1 h-auto hover:shadow-lg hover:scale-105 bg-blue-500 text-white active:scale-100 duration-300 border-2 rounded-md"
