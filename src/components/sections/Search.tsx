...
const Search = () => {
  return (
    <div className="bg-white py-40 px-40 h-screen">
      ...
      <div className="mt-10 h-auto flex flex-wrap items-center justify-center gap-3">
        {skills.map((skill) => (
          <button
            className="border px-4 py-2 rounded-md border-gray-500 text-gray-600 hover:bg-blue-950 hover:text-white"
            key={skill}
          >
            {skill}
          </button>
